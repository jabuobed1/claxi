...
const requestTransitions = {
  [REQUEST_STATUS.PENDING]: [REQUEST_STATUS.MATCHING, REQUEST_STATUS.CANCELED],
  [REQUEST_STATUS.MATCHING]: [REQUEST_STATUS.OFFERED, REQUEST_STATUS.NO_TUTOR_AVAILABLE, REQUEST_STATUS.CANCELED],
  [REQUEST_STATUS.OFFERED]: [REQUEST_STATUS.ACCEPTED, REQUEST_STATUS.MATCHING, REQUEST_STATUS.CANCELED],
  [REQUEST_STATUS.ACCEPTED]: [REQUEST_STATUS.IN_SESSION, REQUEST_STATUS.CANCELED],
  [REQUEST_STATUS.IN_SESSION]: [REQUEST_STATUS.COMPLETED, REQUEST_STATUS.CANCELED],
  [REQUEST_STATUS.NO_TUTOR_AVAILABLE]: [REQUEST_STATUS.MATCHING, REQUEST_STATUS.CANCELED],
  [REQUEST_STATUS.CANCELED]: [],
  [REQUEST_STATUS.COMPLETED]: [],
};

const sessionTransitions = {
  [SESSION_STATUS.WAITING_STUDENT]: [SESSION_STATUS.IN_PROGRESS, SESSION_STATUS.CANCELED],
  [SESSION_STATUS.IN_PROGRESS]: [SESSION_STATUS.COMPLETED, SESSION_STATUS.CANCELED],
