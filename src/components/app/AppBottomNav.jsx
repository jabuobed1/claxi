...
export default function AppBottomNav({ role = 'student' }) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-40 px-3 md:hidden">
      <div className="pointer-events-auto mx-auto flex w-full max-w-2xl items-center justify-between gap-1 overflow-x-auto rounded-[28px] border border-zinc-200/80 bg-white/95 px-2 py-2 shadow-[0_12px_40px_rgba(15,23,42,0.14)] backdrop-blur">
