...
### 13) Firestore rules coverage for business collections not defined in repo
**Problem**
...
### 14) Sensitive debug logs in Cloud Functions
**Problem**
- Paystack verification logs include request body and secret previews.
